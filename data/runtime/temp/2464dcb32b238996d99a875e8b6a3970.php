<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:56:"themes/admin_simpleboot3/portal\admin_article\index.html";i:1511839833;s:43:"themes/admin_simpleboot3/public\header.html";i:1511839833;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <form class="js-ajax-form" action="" method="post">
        ...
        <table class="table table-hover table-bordered table-list">
            ...
            <tr>
                ...
                <th width="80">作者</th>
                <th width="120">关键字/来源<br>摘要/缩略图</th>
            ...
            <?php if(is_array($articles) || $articles instanceof \think\Collection || $articles instanceof \think\Paginator): if( count($articles)==0 ) : echo "" ;else: foreach($articles as $key=>$vo): ?>
                <tr>
                    ...
                    <td>
                        ...
                        <?php if(empty($vo['more']['files']) || (($vo['more']['files'] instanceof \think\Collection || $vo['more']['files'] instanceof \think\Paginator ) && $vo['more']['files']->isEmpty())): else: $file_url=cmf_get_file_download_url($vo['more']['files'][0]['url']); ?>
                            <a data-toggle="tooltip" title="下载" href="<?php echo $file_url; ?>" download>
