...
use app\portal\model\PostVisitorLogModel;
use think\Db;
...
class ArticleController extends HomeBaseController
{
    ...
    //    $this->logPostVisitor($userId, $articleId);
...
tpl;
     ...
     * @param $postId     *
     */
    public function logPostVisitor($userId, $postId, $host){
        $model = new PostVisitorLogModel();
        $exist = $model->checkExist($postId);
        if($exist){
            return 'exist';
        }
        $rs = $model->addPostVisitorLog($userId, $postId, $host);
        if($rs){
            return 'ok';
        }
        return 'error';
