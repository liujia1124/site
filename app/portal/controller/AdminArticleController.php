...
class AdminArticleController extends AdminBaseController
{
    ...
    public function addPost()
    {
        if ($this->request->isPost()) {
            ...
            $data['post']['post_title'] = $this->tran($data['post']['post_title']);
            $data['post']['post_keywords'] = $this->tran($data['post']['post_keywords']);
            $data['post']['post_content'] = $this->tranContent($data['post']['post_content']);
    ...
    public function editPost()
    {
        ...
        if ($this->request->isPost()) {
         ...
         //   echo $data['post']['post_content'];exit;
            $data['post']['post_title'] = $this->tran($data['post']['post_title']);
            $data['post']['post_keywords'] = $this->tran($data['post']['post_keywords']);
            $data['post']['post_content'] = $this->tranContent($data['post']['post_content']);
