...
class FanJianConvertController{
    ...
    public static function tradition2simple($sContent){
        ...
        for($i=0;$i<$iContent;$i++){
            ...
            $match=mb_strpos(FanJianConvertController::$td,$str,null,'UTF-8');
            $simpleCN.=($match!==false )?mb_substr(FanJianConvertController::$sd,$match,1,'UTF-8'):$str;
        }
        return $simpleCN;
    }
    public static function simple2tradition($sContent){
        ...
        for($i=0;$i<$iContent;$i++){
            $str=mb_substr($sContent,$i,1,'UTF-8');
            $match=mb_strpos(FanJianConvertController::$sd,$str,null,'UTF-8');
            $traditionalCN.=($match!==false )?mb_substr(FanJianConvertController::$td,$match,1,'UTF-8'):$str;
        }
